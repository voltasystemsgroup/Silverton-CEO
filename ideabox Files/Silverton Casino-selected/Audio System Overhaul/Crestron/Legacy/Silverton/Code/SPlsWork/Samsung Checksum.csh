...
[BEGIN]
  ObjTp=Hd
  Cmn1=This SMPL+ module is only to be used in conjuction\\with the Samsung||1
  Cmn2=PPM50H3 Plasma module.
[END]
[BEGIN]
  ObjTp=Symbol
  Exclusions=1,19,20,21,88,89,310,718,756,854,
  Name=Samsung Checksum (cm)
  SmplCName=Samsung Checksum.csp
  Code=1
  InputList2Cue1=From_Smpl$
  InputList2SigType1=Serial
  OutputList2Cue1=To_Device$
  ...
  SPlus2CompiledName=S2_Samsung_Checksum
  SymJam=NonExclusive
[END]
[BEGIN]
  ObjTp=Dp
